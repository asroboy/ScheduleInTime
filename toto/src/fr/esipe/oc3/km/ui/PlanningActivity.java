...
import fr.esipe.oc3.km.receiver.AlarmManagerBroadcastReceiver;
import fr.esipe.oc3.km.services.UpdatingEventDbService;
import fr.esipe.oc3.km.services.UploadingToCalendar;
...
public class PlanningActivity extends FragmentActivity{
	 ...
	 * @param isUbdated
	 */
	private void setRefreshing(boolean refreshing, boolean isUbdated) {
